...
from helpers.config_bigquery import dataset_name, json_key_path, project_id, pitcher_table_name
...
players_df = pd.read_csv('pitchers_with_ids_2024.csv')
...
final_pitching_stats = pd.merge(filtered_pitching_stats, players_df[['IDfg', 'eligible_positions']], on='IDfg', how='left')

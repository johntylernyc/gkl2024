...
from helpers.config_bigquery import dataset_name, json_key_path, project_id, batter_table_name
...
players_df = pd.read_csv('players_with_ids_2024.csv')
...
final_batting_stats = pd.merge(filtered_batting_stats, players_df[['IDfg', 'eligible_positions']], on='IDfg', how='left')

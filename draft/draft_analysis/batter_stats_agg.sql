CREATE OR REPLACE TABLE `python-sandbox-381204.gkl2024_draft_analysis.batter_stats_agg` AS
SELECT 
  IDfg,
  Name,
  AVG(AB) AS avg_ab,
  ...
  team_name
FROM 
  `python-sandbox-381204.gkl2024_draft_analysis.batters_stats`
WHERE 
  Season BETWEEN 2021 AND 2023
  AND eligible_positions NOT IN ("SP", "RP", "P")
GROUP BY 
  IDfg, Name, eligible_positions, team_name;